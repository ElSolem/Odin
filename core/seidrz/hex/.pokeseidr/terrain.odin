...
mountain_tiles : [9]^Surface = {
    0 = nil,
    1 = sdl2image.Load("assets/tilesets/mountain/water_ring.png"),
    2 = sdl2image.Load("assets/tilesets/mountain/gravel_spot.png"),
    3 = sdl2image.Load("assets/tilesets/mountain/snowstone_ring.png"),
    4 = sdl2image.Load("assets/tilesets/mountain/graycave_spot.png"),
    5 = sdl2image.Load("assets/tilesets/mountain/graycave_ring.png"),
    6 = sdl2image.Load("assets/tilesets/mountain/snowstone_spot.png"), 
    7 = sdl2image.Load("assets/tilesets/mountain/gravel_ring.png"),
